...
public class Giocatore
{
	...
	/*
	 * Dato che ogni giocatore pu� possedere pi� di una tessera per tipo terreno,
	 * questa possibilit� comparir� come un elemento in pi� nella lista
	 */
	...
	public class Spesa_Eccessiva_Exception extends Exception
	{
		...
		{
			super("Spesa oltre i limiti concessi! Il conto non pu� scendere sotto zero");
		}
	}
	...
	public void Rimuovi_Tessera_Terreno(E_Tipo_Terreno tipo_Terreno) throws Rimozione_Tessera_Exception
	{
		if(this.at_tessere_terreno_possedute==null)
		{
			throw new Rimozione_Tessera_Exception("Non � presente alcuna tessera");
		}
